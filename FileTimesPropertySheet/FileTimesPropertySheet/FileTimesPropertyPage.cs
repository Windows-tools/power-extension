...
namespace FileTimesPropertySheet.PropertySheet.FileTimesPropertySheet
{
    public partial class FileTimesPropertyPage : SharpPropertyPage
    {
        ...
        private void FileTimesPropertyPage_Load(object sender, EventArgs e)
        {
            ...
            dateTimePickerModifiedDate.Format = DateTimePickerFormat.Custom;
            dateTimePickerAccessedDate.Format = DateTimePickerFormat.Custom;

            string format = "dd-MM-yyyy";
            dateTimePickerCreatedDate.CustomFormat = format;
            dateTimePickerModifiedDate.CustomFormat = format;
            dateTimePickerAccessedDate.CustomFormat = format;
        }
        ...
        {
            var res = MessageBox.Show("Are you sure to change file times ?", "File Time Change", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
